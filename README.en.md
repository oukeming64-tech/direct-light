...
**Current version: `v1.0.2` — adds user-customizable figure models (with two new figures) on top of the first stable release `v1.0.0` (2026-06-24).** The white-studio lighting-previz core is feature-complete, with full runtime localization in 简体中文 / English / 日本語.

- 🌐 **Web**: <https://oukeming64-tech.github.io/direct-light/> — no install, auto-updated on every push to `main`.
- 🖥️ **macOS desktop**: the `.dmg` on the [v1.0.2 release](https://github.com/oukeming64-tech/direct-light/releases/latest) (universal Apple Silicon / Intel, unsigned — see the desktop section for first-launch steps).
