...
- 🧭 **项目展示页**：<https://oukeming64-tech.github.io/direct-light/showcase/> —— 参考 Apple MacBook Neo 产品页节奏重做，在线 demo 仍保留在根路径。
...
- 多语言 UI（v1.0 起完整支持）：顶栏语言菜单可切 简体中文 / English / 日本語；界面、内置显示标签和 A/B 派生文案已全部三语化。用户输入名、品牌/型号、单位、数据 id 不翻译。见 [`V0_10_I18N_SPEC.md`](../specs/V0_10_I18N_SPEC.md)。
...
- [`README.md`](../../../README.md)：当前开源门面；本归档文件保留旧完整 README / PRD。
- [`README.en.md`](../../../README.en.md)：English readme.
- [`ARCHITECTURE.md`](../../../ARCHITECTURE.md)：当前代码主干、模块边界和目录组织规范。
- [`RENDERING_SPEC.md`](../../../RENDERING_SPEC.md)：当前渲染逻辑、默认灯光、白棚反射和阴影规则。
