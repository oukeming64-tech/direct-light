...
- GitHub Pages now has two public entry points: root `/direct-light/` is still the live app/demo, and `/direct-light/showcase/` is the Apple-inspired project page for GitHub visitors.
